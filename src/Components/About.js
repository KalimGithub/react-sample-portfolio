...
const About = ()=>{
    return(
        <diV id="about">
            <h1>About Me</h1>
            <br/>
            <img id="image" src="https://plus.unsplash.com/premium_photo-1681912324377-d1427cc147b6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="img"/>
            <br/>
            <p>
